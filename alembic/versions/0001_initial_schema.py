...
Matches the existing raw-SQL schema from storage/database.py plus the
new sync_log table and created_at columns on entity tables.
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("last_modified_at", sa.Integer()),
        sa.Column("fetched_at", sa.Text()),
    )
