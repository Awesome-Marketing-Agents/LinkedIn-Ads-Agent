"""Pydantic models for LinkedIn Marketing API response validation.

These models validate raw JSON from the LinkedIn REST API before it enters
the persistence pipeline. Unknown fields are silently ignored.
"""
